...
def Void_and_cluster_downsampling(points_xyz, n_clusters=4, n_components=4):

    vertex_coord_list, keypoint_indices_list = Void_and_Cluster_Sampling.Void_and_Cluster(points_xyz, n_clusters=4, n_components=4)
...
def gen_multi_level_local_graph_v3(
    ...
    if downsample_method == 'void_and_cluster':
        vertex_coord_list, keypoint_indices_list = \
            Void_and_cluster_downsampling(points_xyz)
