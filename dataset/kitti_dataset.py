...
from Void_and_Cluster_Sampling import Void_and_Cluster_Downsampling
...
class KittiDataset(object):
    ...
    def get_cam_points(self, frame_idx,
        ...
        if downsample_voxel_size is not None:
            if downsample_voxel_size == 'void_and_cluster':
                cam_points = Void_and_Cluster_Downsampling(cam_points, n_clusters = 4, n_components = 4, n_neighbors = 128)
            else:
